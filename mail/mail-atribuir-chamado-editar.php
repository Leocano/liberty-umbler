...
try {
     ...
     $mail->Subject = '[LETNIS] O chamado ' . $id_ticket . ' foi atribuído a você! - Prioridade: ' . $mail_info[0]->desc_priority;//Assunto do e-mail
     ...
     $mail->MsgHTML(
        ...
        <br>
        <br>
        <b>Criado por:</b> " . $mail_info[0]->name . " (" . $mail_info[0]->name_company . ")
        <br>
        <b>Prioridade:</b> " . $mail_info[0]->desc_priority . "
        <br>
        <b>Categoria:</b> " . $mail_info[0]->desc_category . "
        <br>
        <b>Assunto:</b> " . $subject . "
        <br>
        <br>
