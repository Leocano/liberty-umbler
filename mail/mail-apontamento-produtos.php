...
try {
     ...
     //Define o remetente
     // =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=    
     $mail->SetFrom('helpdesk@letnis.com.br', 'LIBERTY Produtos - Help Desk'); //Seu e-mail
     $mail->Subject = '[LETNIS - Produtos] Nova interação no chamado ' . $id_ticket . ' (' . $subject . ')';//Assunto do e-mail
